...
#' @export
transfer_umap_coords <- function(x,
                                 training_set,
                                 test_set,
                                 umap1_var,
                                 umap2_var,
  ...
  if (is(x, "Seurat")) {
    train_umap_1 <- x@meta.data[rownames(training_set), umap1_var]
    train_umap_2 <- x@meta.data[rownames(training_set), umap2_var]
    ...
    # TODO: or also make common part start earlier...
